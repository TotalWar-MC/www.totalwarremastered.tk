...
<head>
  ...
  <title>MassWhitelist - Charts</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Welcome to Charts!</h1>
          <p class="mb-4">Charts are currently in preview and the actual feature will be released in one of the upcoming MassWhitelist versions! Stay tuned to learn more! Click the plugin name on the top left of this page to be redirected to our GitHub page, where you can star our plugins and watch it to receive notifications! Chart examples will follow.</p>
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <hr>
                  An Area Chart can show how many whitelist applications your server got throughout the year!
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <hr>
                  A donut chart is ideal for showing how many of the applied players were accepted or denied.
                </div>
              </div>
            </div>
          </div>
